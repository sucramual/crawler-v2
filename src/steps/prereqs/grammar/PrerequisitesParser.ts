...
export class PrerequisitesParser extends Parser {
  ...
  public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(
    PrerequisitesParser._LITERAL_NAMES,
    PrerequisitesParser._SYMBOLIC_NAMES,
    []
  );
  ...
  public get grammarFileName(): string {
    return "Prerequisites.g4";
  }

  // @Override
  public get ruleNames(): string[] {
    return PrerequisitesParser.ruleNames;
  }

  // @Override
  public get serializedATN(): string {
    return PrerequisitesParser._serializedATN;
  }
  ...
  public term(): TermContext {
    ...
    try {
      ...
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        _la = this._input.LA(1);
        while (
          _la === PrerequisitesParser.AND ||
          _la === PrerequisitesParser.OR
        ) {
          {
            {
              this.state = 58;
  ...
  public operator(): OperatorContext {
    ...
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        _la = this._input.LA(1);
        if (
          !(_la === PrerequisitesParser.AND || _la === PrerequisitesParser.OR)
        ) {
  ...
  public static get _ATN(): ATN {
    if (!PrerequisitesParser.__ATN) {
      PrerequisitesParser.__ATN = new ATNDeserializer().deserialize(
        Utils.toCharArray(PrerequisitesParser._serializedATN)
      );
    }
...
export class ParseContext extends ParserRuleContext {
  ...
  public EOF(): TerminalNode | undefined {
    return this.tryGetToken(PrerequisitesParser.EOF, 0);
  }
...
export class EmptyContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return PrerequisitesParser.RULE_empty;
  }
  // @Override
  public enterRule(listener: PrerequisitesListener): void {
...
export class AtomContext extends ParserRuleContext {
  ...
  public OPARENS(): TerminalNode | undefined {
    return this.tryGetToken(PrerequisitesParser.OPARENS, 0);
  }
  public expression(): ExpressionContext | undefined {
    return this.tryGetRuleContext(0, ExpressionContext);
  }
  public CPARENS(): TerminalNode | undefined {
    return this.tryGetToken(PrerequisitesParser.CPARENS, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
...
export class CourseContext extends ParserRuleContext {
  ...
  public _grade!: Token;
  public COURSE_SUBJECT(): TerminalNode {
    return this.getToken(PrerequisitesParser.COURSE_SUBJECT, 0);
  }
  public COURSE_NUMBER(): TerminalNode {
    return this.getToken(PrerequisitesParser.COURSE_NUMBER, 0);
  }
  public COURSE_PREFIX(): TerminalNode | undefined {
    return this.tryGetToken(PrerequisitesParser.COURSE_PREFIX, 0);
  }
  public GRADE_PREFIX(): TerminalNode | undefined {
    return this.tryGetToken(PrerequisitesParser.GRADE_PREFIX, 0);
  }
  public GRADE_LETTER(): TerminalNode | undefined {
    return this.tryGetToken(PrerequisitesParser.GRADE_LETTER, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
...
export class TestContext extends ParserRuleContext {
  public _name!: Token;
  public _score!: Token;
  public TEST_NAME(): TerminalNode {
    return this.getToken(PrerequisitesParser.TEST_NAME, 0);
  }
  public COURSE_NUMBER(): TerminalNode {
    return this.getToken(PrerequisitesParser.COURSE_NUMBER, 0);
  }
...
export class OperatorContext extends ParserRuleContext {
  public AND(): TerminalNode | undefined {
    return this.tryGetToken(PrerequisitesParser.AND, 0);
  }
  public OR(): TerminalNode | undefined {
    return this.tryGetToken(PrerequisitesParser.OR, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return PrerequisitesParser.RULE_operator;
  }
  // @Override
  public enterRule(listener: PrerequisitesListener): void {
